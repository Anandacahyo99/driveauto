      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-slate-900 text-xl tracking-tight uppercase">
              DriveBridge
            </span>
            {/* Letakkan di header atau di atas daftar file */}
          </div>
          ...
          {isLoggedIn && (
            ...
            {/* <Link
              ...
              className="text-[10px] font-black tracking-widest uppercase text-blue-600 hover:text-blue-700 bg-blue-50 px-4 py-2.5 rounded-xl border border-blue-100 transition-all active:scale-95"
            >
              Statistik Berkas
            </Link> */}
          ...
          {!isLoggedIn ? (
            ...
            >
              ...
              <p className="text-slate-500 text-sm mb-8">
                Masukkan nama untuk mengakses folder pribadi.
              </p>
            ...
            <div className="w-full max-w-4xl flex flex-col items-center">
              ...
              >
                <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-50">
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-red-500 hover:bg-red-50 px-3 py-1 rounded-lg transition-all"
                  >
                    Keluar
                  </button>
                </div>
                ...
                <form onSubmit={handleUpload} className="space-y-6">
                  <label className="group flex flex-col items-center justify-center w-full min-h-[160px] border-2 border-dashed border-slate-200 rounded-[2rem] cursor-pointer hover:bg-blue-50 transition-all">
                    <div className="bg-blue-50 p-3 rounded-2xl mb-3 group-hover:bg-blue-100 transition-all text-blue-600">
                  ...
                  {files.length > 0 && (
                    <div className="space-y-2 max-h-40 overflow-y-auto pr-2 custom-scrollbar">
                      {files.map((f, i) => (
                        ...
                        >
                          <span className="text-xs font-bold text-slate-700 truncate px-2">
                            {f.name}
                          </span>
                          <X
                            size={14}
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-2xl font-black text-white bg-blue-600 shadow-lg shadow-blue-100 hover:bg-blue-700 disabled:bg-slate-100 disabled:text-slate-400 transition-all uppercase tracking-widest text-xs"
                  >
                    {uploading ? (
                      <Loader2 className="animate-spin mx-auto" />
                    ) : (
                      `Simpan ke Folder ${userName}`
                    )}
                  </button>
                </form>
                ...
                {status.type && (
                  <div
                    className={`p-4 rounded-2xl mt-6 flex items-center gap-3 border-2 ${
                      status.type === "success"
              ...
              <div className="w-full px-2">
                ...
                {driveFiles.length === 0 && !loadingFiles && (
                  <div className="text-center py-20 bg-white rounded-[2rem] border-2 border-dashed border-slate-100 text-slate-400 font-medium">
        ...
        {deleteId && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-slate-500 text-sm mb-8">
                File akan dihapus secara permanen dari Google Drive.
              </p>
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-red-500 text-white rounded-2xl font-bold hover:bg-red-600 transition-all flex items-center justify-center"
                >
                  {isDeleting ? (
      ...
      <footer className="bg-white border-t border-slate-200 py-10 mt-auto">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between text-slate-400">
          <p className="text-[10px] font-bold uppercase tracking-wider italic">
            Secure Private Cloud Transfer © 2026
          </p>
